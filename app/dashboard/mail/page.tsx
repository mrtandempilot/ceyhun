...
export default function MailPage() {
  const [activeTab, setActiveTab] = useState<'inbox' | 'compose' | 'server'>('inbox');
  ...
  const sendEmail = async () => {
    ...
    try {
      ...
      // Call your mail server API or n8n webhook to send email
      const response = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({
          ...
          from: 'info@oludenizexplorer.com.tr', // Your mail server email
        }),
      });
        ...
        <div className="px-6 py-4">
          ...
          <div className="flex space-x-1">
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-t-lg font-medium transition-colors ${activeTab === 'compose'
                ? 'bg-gray-900 text-white'
                : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                }`}
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={12}
                    className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-between pt-4">
                  <div className="text-sm text-gray-400">
                    <span className="font-medium">From:</span> info@oludenizexplorer.com.tr
                  </div>
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                    >
                      {composeSending ? (
                        <>
